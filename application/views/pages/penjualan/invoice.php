                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <p><?= number_format($d['harga_jual'], 0, ',', '.') ?></p>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td>
                        <p><?= number_format($data[0]['total_penjualan'], 0, ',', '.') ?></p>
                      </td>
                    </tr>
                  </tfoot>
                </table>
